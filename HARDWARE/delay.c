...
/ ******************************************************************************************当delay_us / delay_ms需要支持OS的时候需要三个与OS相关的宏定义和函数来支持 首先是3个宏定义 : delay_osrunning : 用于表示OS当前是否正在运行, 以决定是否可以使用相关函数 delay_ostickspersec : 用于表示OS设定的时钟节拍, delay_init将根据这个参数来初始哈systick delay_osintnesting : 用于表示OS中断嵌套级别, 因为中断里面不可以调度, delay_ms使用该参数来决定如何运行 然后是3个函数 : delay_osschedlock : 用于锁定OS任务调度, 禁止调度 delay_osschedunlock : 用于解锁OS任务调度, 重新开启调度 delay_ostimedly : 用于OS延时, 可以引起任务调度.

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     本例程仅作UCOSII和UCOSIII的支持,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         其他OS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         请自行参考着移植 支持UCOSII****************************************************************************************** /
//当delay_us/delay_ms需要支持OS的时候需要三个与OS相关的宏定义和函数来支持
...
/**
 * @brief 初始化延迟函数当使用OS的时候,此函数会初始化OS的时钟节拍SYSTICK的时钟固定为HCLK时钟的1/8
 * @param SYSCLK:系统时钟
 */
